...
class MonevController extends Controller
{
    ...
    public function __construct(
        ...
        $this->middleware(function ($request, $next) {
            $this->user = Auth::user();
            $this->havePermissionView = $this->user->can(PERMISSION_MONEV);
            return $next($request);
        });
    }
    /**
    ...
    {
        abort_if(Gate::denies(PERMISSION_MONEV), Response::HTTP_FORBIDDEN, 'Forbidden');
        $rows = [
            [
                'no' => 1,
                    ...
                    [
                        ...
                        'uraian' => [
                            [
                                ...
                                'upload_bukti' => "https://drive.google.com/drive/folders/1eMa0-OT4zqvYYwZw_MG2Ql5pEUd0v8Jo?usp=sharing",
                                'verifikasi_kejagung' => [
                                    'jumlah' => 0,
                                    'nilai' => 0
                                ],
                    ...
                    [
                        ...
                        'uraian' => [
                            [
                                ...
                                'jumlah' => 3,
                                'nilai_percent' => 40/100,
                                'upload_bukti' => "https://drive.google.com/drive/folders/16RWb4J5ODH6QBFDfLRtwbEpr62LPfyB1?usp=sharing",
                                'verifikasi_kejagung' => [
                                    'jumlah' => 0,
                                    'nilai' => 0
                                ],
                    ...
                    [
                        ...
                        'uraian' => [
                            [
                                ...
                                'jumlah' => 3,
                                'nilai_percent' => 30/100,
                                'upload_bukti' => "https://drive.google.com/drive/folders/1BQknfUCbtB51Qmo9gpQVVkQAOlAyZ4xd?usp=sharing",
                                'verifikasi_kejagung' => [
                                    'jumlah' => 0,
                                    'nilai' => 0
                                ],
    ...
    {
        abort_if(Gate::denies(PERMISSION_MONEV), Response::HTTP_FORBIDDEN, 'Forbidden');
        return Excel::download(new MonevExport(
            $this->lapduRepo,
            $this->satuanKerjaRepo,
            $this->penyelidikanRepo,
            $this->penyidikanRepo,
            $this->penuntutanRepo,
            $this->eksekusiRepo,
        ), 'monev.xlsx');
